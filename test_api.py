...
Post = requests.post('http://127.0.0.1:5000/movies', json={'genre': 'Adventure', 'title': 'Wonder Woman', 'year': 2022}).status_code
if Post == 201:
...
Put = requests.put('http://127.0.0.1:5000/movies/3', json={'genre': 'Adventure', 'title': 'Wonder Woman', 'year': 2030}).status_code
if Put == 200:
